	...
	<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
        ...
        <div class="sidebar-inner px-4 pt-3">
            <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-block">
                        ...
                        <a href="assets-admin/img/pages/examples/sign-in.html" class="btn btn-secondary btn-sm d-inline-flex align-items-center">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item">
                    <a href="assets-admin/img/pages/upgrade-to-pro.html" class="btn btn-secondary d-flex align-items-center justify-content-center btn-upgrade-pro">
